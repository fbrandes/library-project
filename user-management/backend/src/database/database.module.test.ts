...
import { DatabaseModule, getDatabaseUrl, poolProvider } from './database.module.js';

describe('getDatabaseUrl', () => {
  it('returns configured database url', () => {
    expect(getDatabaseUrl({ USER_MANAGEMENT_DATABASE_URL: 'postgres://example' })).toBe('postgres://example');
  });
